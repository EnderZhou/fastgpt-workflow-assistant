...
2. 涉及平台能力、版本或节点参数时，读取 [官方文档索引](references/官方文档索引.md) 与 [版本兼容性](references/版本与兼容性.md)；新版本、跨版本迁移或版本未知时，再读取 [多版本适配](references/多版本适配.md) 按版本选择规则。区分平台、节点、应用和技能版本；文档与实例冲突时，以实际导出和运行证据为准并记录漂移。
